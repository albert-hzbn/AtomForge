...
Application source baseline: \code{0df0af2}.\par
...
Menu names and controls describe the source baseline above and the Windows executable used to prepare the figures. Features controlled by build options are marked explicitly. A source file does not by itself mean a feature is accessible in the desktop menu. Common-neighbour analysis, angular-distribution analysis, and the interface builder are not exposed in the baseline menus; this manual does not present them as usable menu commands.
