...
Choose \ui{Analysis > Electronic structure > Electronic Post-processing}. The left column contains tool selection, input files, field/operand selection, calculation parameters, export, and appearance. The right side contains the 3D and 2D views. On a smaller window, scroll the left column to reach \ui{Calculate} and \ui{Export}; the tool buttons remain near the top.
